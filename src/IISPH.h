/*******************************************************************************
 *
 * Description: IISPH SPH fluid solver and boundary handling includes.
 *
 ******************************************************************************/
...
{
public:
    IISPH(Vec3d volumeMin, Vec3d volumeMax, double mass, double restDensity, double h, double k, double dt);
    ~IISPH();
...
private:
	...
	void viadv(SPHParticle &particle,int i);
